...
(assert (forall ((x Int) (y Int) (x_ Int) (y_ Int)) (=> (and (>= x 0) (< x_ x)) (__pred____dwf__p x y x_ y_))))""",
     """
(define-fun __dwf__p ((x!1 Int) (x!2 Int) (x!3 Int) (x!4 Int)) Bool (and (= x!2 0) (= x!4 0) (>= x!1 0) (< x!3 x!1)))"""),
...
(assert (forall ((x Int) (y Int) (x_ Int) (y_ Int)) (=> (and (>= x 0) (> x_ x)) (__pred____dwf__p x y x_ y_))))""",
     """
(define-fun __dwf__p ((x!1 Int) (x!2 Int) (x!3 Int) (x!4 Int)) Bool (and (= x!2 0) (= x!4 1) (>= x!1 0) (< x!1 x!3)))"""),
